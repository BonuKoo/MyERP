...
public record ItemSpecRequest(
        ...
        @NotNull @DecimalMin("0") @Schema(description = "매입 시 기준이 되는 원가") BigDecimal costPrice,
        @NotNull @DecimalMin("0") @Schema(description = "매출 시 기준이 되는 판매가") BigDecimal salePrice,
